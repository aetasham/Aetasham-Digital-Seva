    ...
    <section className="section">
      ...
      {categories.map(category => <div key={category.title} style={{ marginBottom: 36 }}>
        ...
        <div className="grid">{category.items.map(([icon, title, desc, service]) => <article className="service" key={title}>
          ...
          {title === 'PAN Services' && <div><strong>Service Fee: ₹149</strong><br /><a className="serviceOfficialLink" href="https://www.pan.utiitsl.com/" target="_blank" rel="noreferrer">Official PAN Portal ↗</a></div>}
