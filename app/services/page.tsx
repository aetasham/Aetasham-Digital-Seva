    ...
    <section className="section">
      ...
      {categories.map(category => <div key={category.title} style={{ marginBottom: 36 }}>
        ...
        <div className="grid">{category.items.map(([icon, title, desc, service]) => <article className="service" key={title}>
          ...
          {title === 'PAN Services' && <div><strong>Customer Total: ₹149</strong><br /><small>Official fee: ₹107 · Service charge: ₹42</small><br /><a className="serviceOfficialLink" href="https://www.pan.utiitsl.com/" target="_blank" rel="noreferrer">Official PAN Portal ↗</a></div>}
